...
const BOTTOM_NAV = [
  { href:'/dashboard/analytics',  icon:BarChart3,   label:'Analytics', roles:['admin','manager','finance','hr'] },
  { href:'/dashboard/hr',         icon:Users,       label:'HR',        roles:['admin','manager','hr'] },
  ...
  if (loading) return (
    <div style={{ minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', background:'#F8F7F4' }}>
      <div style={{ textAlign:'center' }}>
        <div style={{ width:44, height:44, borderRadius:14, background:'linear-gradient(135deg,#B8860B,#D4A017)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:22, margin:'0 auto 12px', boxShadow:'0 4px 16px rgba(184,134,11,0.3)' }}>🌙</div>
